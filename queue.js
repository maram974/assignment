...
// specify (i.e., design) interface information (arguments and return values, if any)

// --------------------
// implement queue empty condition based on linked list .isEmpty() method
function qEmpty()              // "q" prefix to distinguish from similar function in linked-list package
{
